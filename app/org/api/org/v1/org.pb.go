...
type CreateReq struct {
	...
	// 上级id
	// v:integer|min:0#上级id必须是整数|上级id必须大于0
	ParentId int64 `protobuf:"varint,1,opt,name=parentId,proto3" json:"parentId,omitempty" dc:"上级id" v:"integer|min:0#上级id必须是整数|上级id必须大于0"`
	// 组织名称
	...
	Type int64 `protobuf:"varint,4,opt,name=type,proto3" json:"type,omitempty" dc:"组织分类" v:"integer|min:0#组织分类不正确1|组织分类不正确2"`
	// 状态
	Status int64 `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty" dc:"状态"`
	// 主管
	SupervisorIds []int64 `protobuf:"varint,6,rep,packed,name=supervisorIds,proto3" json:"supervisorIds,omitempty" dc:"主管"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateReq) GetSupervisorIds() []int64 {
	if x != nil {
...
type UpdateReq struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// id
	// v:integer|min:0#id必须是整数|id必须大于0
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" dc:"id" v:"integer|min:0#id必须是整数|id必须大于0"`
	// 上级id
	// v:integer|min:0#上级id必须是整数|上级id必须大于0
	...
	// 组织分类
	// v:integer|min:0#组织分类不正确1|组织分类不正确2
	Type int64 `protobuf:"varint,5,opt,name=type,proto3" json:"type,omitempty" dc:"组织分类" v:"integer|min:0#组织分类不正确1|组织分类不正确2"`
	// 状态
	Status int64 `protobuf:"varint,6,opt,name=status,proto3" json:"status,omitempty" dc:"状态"`
	// 主管
	SupervisorIds []int64 `protobuf:"varint,7,rep,packed,name=supervisorIds,proto3" json:"supervisorIds,omitempty" dc:"主管"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateReq) GetSupervisorIds() []int64 {
	if x != nil {
		return x.SupervisorIds
	}
	return nil
...
const file_org_v1_org_proto_rawDesc = "" +
	"\n" +
	"\x10org/v1/org.proto\x12\x06org.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x18\n" +
	"\x06GetReq\x12\x0e\n" +
	...
	"\bcreateAt\x18\x06 \x01(\tR\bcreateAt\"\xa1\x01\n" +
	"\tCreateReq\x12\x1a\n" +
	"\bparentId\x18\x01 \x01(\x03R\bparentId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04code\x18\x03 \x01(\tR\x04code\x12\x12\n" +
	"\x04type\x18\x04 \x01(\x03R\x04type\x12\x16\n" +
	"\x06status\x18\x05 \x01(\x03R\x06status\x12$\n" +
	"\rsupervisorIds\x18\x06 \x03(\x03R\rsupervisorIds\"\xb1\x01\n" +
	"\tUpdateReq\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1a\n" +
	"\bparentId\x18\x02 \x01(\x03R\bparentId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x12\n" +
	...
	"\rsupervisorIds\x18\a \x03(\x03R\rsupervisorIds\"\v\n" +
	"\tCreateRes\"\v\n" +
	"\tUpdateRes2\xc7\x01\n" +
	"\x03Org\x12'\n" +
	"\x03Get\x12\x0e.org.v1.GetReq\x1a\x0e.org.v1.GetRes\"\x00\x123\n" +
	"\aGetList\x12\x12.org.v1.GetListReq\x1a\x12.org.v1.GetListRes\"\x00\x120\n" +
	"\x06Create\x12\x11.org.v1.CreateReq\x1a\x11.org.v1.CreateRes\"\x00\x120\n" +
	"\x06Update\x12\x11.org.v1.UpdateReq\x1a\x11.org.v1.UpdateRes\"\x00B\x0eZ\f./api/org/v1b\x06proto3"
...
var file_org_v1_org_proto_goTypes = []any{
	...
	(*CreateReq)(nil),             // 6: org.v1.CreateReq
	(*UpdateReq)(nil),             // 7: org.v1.UpdateReq
	(*CreateRes)(nil),             // 8: org.v1.CreateRes
	(*UpdateRes)(nil),             // 9: org.v1.UpdateRes
...
var file_org_v1_org_proto_depIdxs = []int32{
	...
	10, // 1: org.v1.GetListReq.parentId:type_name -> google.protobuf.Int64Value
	...
	6,  // 5: org.v1.Org.Create:input_type -> org.v1.CreateReq
	7,  // 6: org.v1.Org.Update:input_type -> org.v1.UpdateReq
	1,  // 7: org.v1.Org.Get:output_type -> org.v1.GetRes
	4,  // 8: org.v1.Org.GetList:output_type -> org.v1.GetListRes
	8,  // 9: org.v1.Org.Create:output_type -> org.v1.CreateRes
	9,  // 10: org.v1.Org.Update:output_type -> org.v1.UpdateRes
